...
class GitHubService:
    ...
    def __init__(self):
        ...
        # GitHub App credentials (optional — used when PAT is unavailable)
    ...
    def _can_use_app_auth(self) -> bool:
        return bool(_JWT_AVAILABLE and self.client_id and self.private_key and self.installation_id)
